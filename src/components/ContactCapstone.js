...
//This contact form is for the Movie Database

const ContactCapstone = () => { 
            ...
            <section className= "social-media-bottom space-between">
                <h3 className="about-title padding-bottom-less">Like What you see?</h3> 
                 <div className="github-link-bottom padding-bottom-less">
                    ...
                    <a href onClick={()=> window.open("https://github.com/htpwebdesign/fwd-fitness")} className="github">
    ...
    export default ContactCapstone;